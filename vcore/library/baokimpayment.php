...
class BaoKimPayment 
{
    ...
    // Mã merchante site 
    private $merchant_id = '8234';    // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

    // Mật khẩu bảo mật
    private $secure_pass = '798473977b81a282'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
