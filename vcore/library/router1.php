    ...
    function _validate_request($segments)
    {
        ...
        if (is_dir(APPPATH.'modules/'.$segments[0]))
        {
            ...
            if (count($segments) > 0)
            {
                ...
                if ( ! file_exists(APPPATH.'modules/'.$segments[0].'/'.$this->fetch_directory().$segments[0].EXT))
                {
            ...
            else
            {
                ...
                if ( ! file_exists(APPPATH.'modules/'.$segments[0].'/'.$this->fetch_directory().$this->default_controller.EXT))
                {
                    $this->directory = '';
                    return array();
                }
