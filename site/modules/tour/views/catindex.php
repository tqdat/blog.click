...
<?php
  ...
  ?>
    ...
    <form id="xemthem">
        <input class="btn_send" type="submit" style="float: right; margin-right:10px" value="Xem thêm <?=$total_rows - 18?> tour">
  <input type="hidden" name="catid" value="<?=$str_ar_cat?>">
  <input type="hidden" name="offset" id="offset" value="18">
    </form>
  <?php    
   }
?>  
