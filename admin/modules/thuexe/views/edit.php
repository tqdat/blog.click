        ...
        <td>
            <table class="form">
                ...
                <tr>
                    ...
                    <td><input type="text" name="vdata[loaixe]" value="<?php echo $rs->loaixe?>"></td>
                </tr>
                <tr>
                    <td class="label">Nhãn hiệu</td>
                    <td><input type="text" name="vdata[nhanhieu]" value="<?php echo $rs->nhanhieu?>"></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <b>Nội dung</b>
                        <?=vnit_editor(htmlspecialchars_decode($rs->thongtin),'thongtin','full')?>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table style="margin-left: 10px;">
                <tr>
                    <td style="width: 200px;">
                        <div class="imgmain" style="border: 1px solid #CCC; background: #FFF;width: 150px;height: 100px;margin-bottom: 10px;">
                            <img src="<?=base_url_site()?>data/thuexe/200/<?=$rs->images?>" alt="">
                        </div>
                ...
                <tr>
                    <td>
                        ...
                        <?foreach($img as $val):?>
                        <li>
                              <div class="img" img_src="<?=$val->path?>"><img src="<?=base_url_site()?>data/thuexe/100/<?=$val->path?>"></div>
...
$(document).ready(function() {
    $('#file_upload').uploadify({
        ...
        'uploader'    : base_url+'thuexe/uploader_edit/<?=$rs->id?>',    
        'width': 130,
        'height'    : 30,
        ...
        'onUploadSuccess' : function(file, data, response) {
            ...
            if(obj.error == 0){
                var html ='<li>'+
                          '<div class="img" img_src="'+obj.filename+'"><img src="'+base_url_site+'data/thuexe/100/'+obj.filename+'"></div>'+
    ...
    $(".del_img").live('click',function(){
        ...
        $.post(base_url+"thuexe/del_img",{'id':id},function(data){
            if(img_src == img_old){
                $("#images").val('');
                $(".imgmain").html('');
            }
    ...
    $(".img").live('click',function(){
        ...
        $(".imgmain").html('<img src="'+base_url_site+'data/thuexe/200/'+img_src+'">');
        $("#images").val(img_src);
    })
})
</script>
