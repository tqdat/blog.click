...
<table class="admindata">
    ...
    <tr class="row<?php echo $k?>">
        ...
        <td><a href="<? echo site_url('company/category/ds/'.$rs->catid)?>"><?php echo $rs->catname?></a></td>
        <td align="center">
        ...
        <td align="center">
            <?php echo icon_edit('company/category/editmaincat/'.$rs->catid)?>
            <span id="publish<?php echo $rs->catid?>"><?php echo icon_active("'company_cat'","'catid'",$rs->catid,$rs->published)?></span>
            <?php echo icon_del('company/category/delmaincat/'.$rs->catid)?>
        </td>
    </tr>
    <?
    $k = 1 - $k;
