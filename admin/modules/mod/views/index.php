...
<table class="admindata">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 150px;"><?php echo vnit_order('mod/ds/?f=module&o=desc','Modules')?></th>
            <th style="width: 150px;"><?php echo vnit_order('mod/ds/?f=position&o=desc','Vị trí')?></th>
            <th style="width: 100px;"><?php echo vnit_order('mod/ds/?f=params&o=desc','Style')?></th>
            <th style="width: 100px;"><?php echo vnit_order('mod/ds/?f=ordering&o=desc','Sắp xếp')?> <?php echo action_order()?></th>
