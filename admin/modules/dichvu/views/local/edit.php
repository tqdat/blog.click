        ...
        <td valign="top" style="padding-right: 10px;">
            <table class="form">
                ...
                <tr>
                    ...
                    <td><input type="text" name="vdata[title]" value="<?php echo $rs->title?>" style="width: 99%;"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="vdata[address]" id="address" value="<?php echo $rs->address?>" style="width: 99%;"></td>
                </tr>
                <tr>
                    <td class="label">Tọa độ bản đồ</td>
                    <td>
                        Lat: <input type="text" name="vdata[lat]" id="lat" value="<?php echo $rs->lat?>" class="w100">
                        Lng: <input type="text" name="vdata[lng]" id="lng" value="<?php echo $rs->lng?>" class="w100">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="noibat" <?=($rs->noibat == 1)?'checked="checked"':''?> value="1">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <h2>Giới thiệu ngắn</h2>
                        <textarea style="width: 99%;" name="vdata[introtext]" rows="5"><?=$rs->introtext?></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <h2>Chi tiết</h2>
                        <?=vnit_editor($rs->content,'content','_tongquan')?>
                    </td>
                </tr>
        </table>       
    </td>
        ...
        <fieldset class="content-right">
            <legend>Hình đại diện</legend>
                 <div class="img-news imgmain">
                    <?if($rs->images != ''){?>
                        <img class="img" src="<?=base_url_site()?>data/service/200/<?=$rs->images?>" alt="">
                    <?}else{?>
