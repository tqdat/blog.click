        ...
        <td valign="top" style="padding-right: 10px;">
            <table class="form">
                <tr>
                    ...
                    <td><input type="text" name="vdata[ten]" value="<?php echo set_value('vdata[ten]')?>" style="width: 99%;"></td>
                </tr>
                <tr>
                    <td class="label">Links</td>
                    <td><input type="text" name="vdata[links]" value="<?php echo set_value('vdata[links]')?>" style="width: 99%;"></td>
                </tr>
                <tr>
