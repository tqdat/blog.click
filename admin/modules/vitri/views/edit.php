...
<table class="form">
    <tr>
        ...
        <td>
            <select id="catid" name="vdata[catid]" style="width: 308px;">
                ...
                <option value="<?=$val->catid?>" <?=($val->catid == $rs->catid)?'selected="selected"':'';?>><?=$val->name?></option>
                <?endforeach;?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <select id="d_id" name="vdata[d_id]" style="width: 308px;">
                ...
                <option value="<?=$val->d_id?>" <?=($val->d_id == $rs->d_id)?'selected="selected"':'';?>><?=$val->d_name?></option>
                <?endforeach;?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td><input type="text" name="vdata[vitri_ten]" value="<?php echo $rs->vitri_ten?>" class="w300"></td>
    </tr>
    <tr>
        <td class="label">Lat</td>
        <td><input type="text" name="vdata[vitri_lat]" value="<?php echo $rs->vitri_lat?>" class="w100"></td>
    </tr>
    <tr>
        <td class="label">Lng</td>
        <td><input type="text" name="vdata[vitri_lng]" value="<?php echo $rs->vitri_lng?>" class="w100"></td>
    </tr>    
</table>
<?php echo form_close();?>
