...
<table class="form">
    ...
    <tr>
        ...
        <td>
            <select name="vdata[vitri]" style="width: 200px;">
                <option value="1" <?=($rs->vitri == 1)?'selected="selected"':'';?>>Vị trí 1</option>
                <option value="2" <?=($rs->vitri == 2)?'selected="selected"':'';?>>Vị trí 2</option>
                <option value="3" <?=($rs->vitri == 3)?'selected="selected"':'';?>>Vị trí 3</option>
            </select> (300 x 250)
        </td>
    </tr>
    <tr>
