...
<table class="admindata">
    ...
    <tr class="row<?php echo $k?>">
        ...
        <td><a href="<? echo site_url('adv/newshome/edit/'.$rs->id)?>"><?php echo $rs->name?></a></td>
        <td>
            Vị trí <?=$rs->vitri?>
        </td>
        ...
        <td align="center">
            <?php echo icon_edit('adv/newshome/edit/'.$rs->id)?>
            <span id="publish<?php echo $rs->id?>"><?php echo icon_active("'adv_news_home'","'id'",$rs->id,$rs->published)?></span>
            <?php echo icon_del('adv/newshome/del/'.$rs->id)?>
        </td>
    </tr>
    <?
    $k = 1 - $k;
