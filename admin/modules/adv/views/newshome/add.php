    ...
    <tr>
        ...
        <td>
            <select name="vdata[vitri]">
                ...
                <option value="<?=$val->vitri?>"><?=$val->tenvitri?> (<?=$val->width?> x <?=$val->height?>)</option>
                <?endforeach;?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li style="float: left;width: 200px;"><input type="checkbox" name="ar_id[]" value="<?=$val->cat_id?>"><?=$val->cat_name?></li>
                <?endforeach;?>
            </ul>
        </td>
    </tr>
