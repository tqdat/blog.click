    ...
    <tr>
        ...
        <td>
            <select name="vdata[vitri]">
                <option value="1" <?=($rs->vitri == 1)?'selected="selected"':'';?>>Vị trí 1 - 740 x 100 Picxel</option>
                <option value="2" <?=($rs->vitri == 2)?'selected="selected"':'';?>>Vị trí 2 - 259 x 250 Picxel</option>
            </select>
        </td>
    </tr>
    <tr>
