...
<table class="form">
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="td_inbound" value="IN" <?=($td_inbound_show == 'IN')?'checked="checked"':''?>> Trong nước - 
            <input type="radio" name="td_inbound" value="OUT" <?=($td_inbound_show == 'OUT')?'checked="checked"':''?>> Nước ngoài
        </td>
    </tr>
    <tr id="trongnuoc" style="display: <?=($td_inbound_show == 'IN')?'table-row':'none'?>;">
    ...
    <tr id="nuocngoai" style="display: <?=($td_inbound_show == 'OUT')?'table-row':'none'?>;">
