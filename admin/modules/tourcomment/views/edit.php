...
<table class="form">
    ...
    <tr>
        ...
        <td><input type="text" name="vdata[phone]" value="<?=$rs->phone?>" class="w300"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="vdata[is_home]" value="1" <?php echo ($rs->is_home == 1)?'checked="checked"':'checked="checked"';?>>Có
            <input type="radio" name="vdata[is_home]" value="0" <?php echo ($rs->is_home == 0)?'checked="checked"':'';?>> Không 
        </td>
    </tr> 
    ...
    <tr>
        <td>
         <div class="img-news">
            ...
            <?}else{?>
                <img src="<?=base_url_site()?>data/comment/<?=$rs->avatar?>" alt="">
            <?}?>
         </div>
